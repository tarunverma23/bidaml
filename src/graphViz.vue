    ...
    methods: {
                ...
                if (action.newNode) {
                  ...
                  const newNodeArr = newNodes.map(n => {
                    const defaultNode = {
                      ...
                      isSnip: false,
                      fixed: true,
                      color: '#ffeca8',   //color for all shapes and icons
                      fixedWidth: false,
                    };
      ...
      createGraph() {
        ...
        const layoutOptions = {
          ...
          nodeToColor: function nodeToColor(d) {   //color of icons
            //alert(d.nodeShape);
            //return false;
          ...
          nodePath: (d) => {
            switch (d.nodeShape) {
              ...
              case 'capsule': {  //now comment box
              return 'M184 132H414C430 132 443 145 443 160V319C443 334 430 347 414 347H277L231 398C230 399 229 400 227 400 227 400 226 400 226 400 224 399 223 397 223 395V347H184C169 347 156 334 156 319L156 160C156 145 169 132 184 132Z';

              }

              case 'file': {  // file
              return 'M315 152 294 110 179 110C167 110 158 119 158 131L158 320C158 332 167 341 179 341L442 341C453 341 463 332 463 320L463 173C463 161 453 152 442 152L315 152 315 152ZM309 162 288 120 179 120C173 120 168 125 168 131L168 320C168 326 173 331 179 331L442 331C448 331 452 326 452 320L452 173C452 167 447 162 442 162L309 162 309 162Z';
              ...
              case 'diamond': {  //diamond
              return 'm64.132 147.54c.339.508 .909.812 1.519.812s1.18-.304 1.519-.812l32.182-48.166c.41-.615.41-1.416 0-2.029l-32.181-48.166c-.339-.508-.909-.812-1.519-.812s-1.18.304-1.519.812l-32.182 48.166c-.41.613-.41 1.414 0 2.029zm1.52-94.058 29.983 44.876-29.983 44.879-29.983-44.879zm0 0';
              ...
              case 'report': {  //report
              return 'M50.031 49.357 50.031 46.238C50.031 42.817 52.825 40.022 56.27 40.022L59.351 40.022C62.808 40.022 65.59 42.805 65.59 46.238L65.59 49.357 71.827 49.357C73.54 49.357 74.925 50.748 74.925 52.465L74.925 55.583C74.925 57.314 73.538 58.692 71.827 58.692L43.794 58.692C42.08 58.692 40.696 57.3 40.696 55.583L40.696 52.465C40.696 50.734 42.083 49.357 43.794 49.357L50.031 49.357 50.031 49.357ZM46.919 46.245 43.816 46.245C40.379 46.245 37.593 49.018 37.584 52.468L34.465 52.468C31.032 52.468 28.249 55.237 28.249 58.703L28.249 124.026C28.249 127.469 31.021 130.261 34.465 130.261L81.156 130.261C84.589 130.261 87.372 127.492 87.372 124.026L87.372 58.703C87.372 55.259 84.599 52.468 81.156 52.468L78.036 52.468 78.036 52.468C78.029 49.03 75.251 46.245 71.804 46.245L68.701 46.245C68.699 41.089 64.5 36.91 59.337 36.91L56.283 36.91C51.114 36.91 46.922 41.074 46.919 46.245L46.919 46.245 46.919 46.245ZM78.036 55.58 81.148 55.58C82.845 55.58 84.26 56.977 84.26 58.701L84.26 124.027C84.26 125.783 82.867 127.149 81.148 127.149L34.473 127.149C32.776 127.149 31.361 125.751 31.361 124.027L31.361 58.701C31.361 56.946 32.754 55.58 34.473 55.58L37.584 55.58C37.593 59.018 40.37 61.803 43.816 61.803L71.804 61.803C75.241 61.803 78.029 59.03 78.036 55.58L78.036 55.58 78.036 55.58ZM57.81 49.357C58.67 49.357 59.366 48.66 59.366 47.801 59.366 46.942 58.67 46.245 57.81 46.245 56.951 46.245 56.255 46.942 56.255 47.801 56.255 48.66 56.951 49.357 57.81 49.357L57.81 49.357Z';
              ...
              case 'code_file': {  // code_file
              return 'M90.795 49.623q1.129 1.129 1.936 3.065t.807 3.55v46.468q0 1.614-1.129 2.743t-2.743 1.129h-54.213q-1.614 0-2.743-1.129t-1.129-2.743v-64.539q0-1.614 1.129-2.743t2.743-1.129h36.142q1.614 0 3.55.807t3.065 1.936zm-17.909-9.842v15.166h15.166q-.403-1.17-.887-1.654l-12.625-12.625q-.484-.484-1.654-.887zm15.489 61.635v-41.305h-16.78q-1.614 0-2.743-1.129t-1.129-2.743v-16.78h-30.979v61.958h51.631z';
